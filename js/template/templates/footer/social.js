    ...
    async getHtml(){
        return `<div class="footer__socials" aria-label="Social Links">
          ...
          <a href="https://www.linkedin.com/in/jejomar-parrilla-ab5442239/" class="footer__social" aria-label="LinkedIn" target="_blank" rel="noopener">
            <!-- LinkedIn SVG -->
            <svg class="footer__icon" viewBox="0 0 24 24" width="20" height="20" fill="none"><path fill="#a68b6a" d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-9h3v9zm-1.5-10.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm15.5 10.28h-3v-4.5c0-1.08-.02-2.47-1.5-2.47-1.5 0-1.73 1.17-1.73 2.39v4.58h-3v-9h2.89v1.23h.04c.4-.75 1.37-1.54 2.82-1.54 3.01 0 3.57 1.98 3.57 4.56v4.75z"/></svg>
          </a>
          <a href="https://www.facebook.com/jejomar.parrilla/" class="footer__social" aria-label="Facebook" target="_blank" rel="noopener">
            <!-- Facebook SVG -->
            <svg class="footer__icon" viewBox="0 0 24 24" width="20" height="20" fill="none"><path fill="#a68b6a" d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.325 24h11.495v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.674V1.326C24 .592 23.406 0 22.675 0"/></svg>
          </a>
        </div>
        `;
    }
